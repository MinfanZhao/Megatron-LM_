...
def validate_args(args, defaults={}):
    ...
    if args.apply_residual_connection_post_layernorm:
        if args.rank == 0:
            print('--apply-residual-connection-post-layernorm is no longer valid, use --apply-residual-connection-post-norm.')
        exit()
