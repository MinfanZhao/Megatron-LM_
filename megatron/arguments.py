...
def _add_vision_args(parser):
    ...
    group.add_argument('--mask-ratio', type=float, default=0.75, 
                       help='mae mask ratio')
    group.add_argument('--decoder-ffn-size', type=int, default=2048,
                        help='decoder ffn hidden size, in general be 4x decoder embed dim')
    group.add_argument('--kv-channels-decoder', type=int, default=32,
                        help='decoder embed dim divide heads')
    group.add_argument('--decoder-num-attention-heads', type=int, default=16)
    group.add_argument('--norm-pix-loss', action='store_true',
                        help='Use (per-patch) normalized pixels as targets for computing loss')
    
    group.add_argument('--mean', type=str, default=None)
    group.add_argument('--std', type=str, default=None)
    # group.add_argument('--color-jitter',)
    # group.add_argument('--aa',)
    # group.add_argument('--reprob',)
    # group.add_argument('--remode',)
    # group.add_argument('--recount',)

    # pretraining type and backbone selection`
    group.add_argument('--vision-pretraining', action='store_true',
                       help='flag to indicate vision pretraining')
    group.add_argument('--vision-pretraining-type', type=str, default='classify',
                       choices=['classify', 'inpaint', 'dino', 'mae'],
                       help='pretraining objectives')
    group.add_argument('--vision-backbone-type', type=str, default='vit',
                       choices=['vit', 'mit', 'swin', 'mae'],
